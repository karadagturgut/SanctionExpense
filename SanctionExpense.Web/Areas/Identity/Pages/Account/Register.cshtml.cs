...
namespace SanctionExpense.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            ReturnUrl = returnUrl;
            AdminList = new List<SelectListItem> { new SelectListItem { Value = "Accountant" , Text="Muhasebe" } ,
                            new SelectListItem { Value = "Employee" , Text="Çalışan" },
                            new SelectListItem { Value = "Executive" , Text="Yönetici" }};
